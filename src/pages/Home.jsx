    ...
    return (
        <>
            ...
            <div className="bg-slate-300/20 flex flex-col justify-center items-center">
                <div className="w-[70%] h-[auto] bg-white my-10 shadow-xl rounded-xl flex flex-col gap-10 justify-center items-center py-6" >
                ...
                <div className='w-full h-[auto] my-8'>
                    <div className='flex flex-col justify-center items-center'>
                        <h1 className='text-center font-bold text-[4.5rem]'>Special Offers</h1>
                    ...
                    <div className='flex justify-center items-center my-11 gap-10'>
                        <div className='bg-white shadow-xl rounded-lg'>

                            <div className='w-[25rem] h-[20rem] relative overflow-hidden rounded-t-lg'>
