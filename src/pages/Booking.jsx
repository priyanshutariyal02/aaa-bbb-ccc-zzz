                    ...
                    <div className='container h-full shadow-xl flex flex-col gap-10 justify-center items-center bg-white'>
                        <div className='grid grid-cols-2 gap-8 justify-center'>
                            ...
                            <div>
                                ...
                                <input type="number" name="phone" id="phone" placeholder='10-digit phone number' className='border border-black w-[20rem] h-[3rem] px-3 outline-none rounded-lg' />
                            </div>
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-8 justify-center'>
                            ...
                            <div>
                                ...
                                <input type="number" name="rooms" id="rooms" placeholder='number of rooms' className='border border-black w-[20rem] h-[3rem] px-3 outline-none rounded-lg' />
                            </div>
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-8 justify-center'>
                            ...
                            <div>
                                ...
                                <input type="number" name="children" id="children" placeholder='number of children' className='border border-black w-[20rem] h-[3rem] px-3 outline-none rounded-lg' />
                            </div>
                        </div>
                        <div className='flex justify-center gap-10'>
                            <button type="submit" className='bg-red-500 text-white py-2 px-6 rounded-lg hover:bg-red-400 transition duration-200'>reset</button>
                            <button type="reset" className='bg-blue-500 text-white py-2 px-6 rounded-lg hover:bg-blue-400 transition duration-200'>submit</button>
                        </div>
