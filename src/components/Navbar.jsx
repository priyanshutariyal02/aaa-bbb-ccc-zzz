        ...
        <header className='bg-black flex justify-between items-center sm:px-16 px-8 py-4 max-w-[115rem] mx-auto absolute top-0 bg-transparent z-10 right-0 left-0'>
            ...
            <nav ref={navRef} className="flex text-lg gap-[10rem] font-medium md-device">
                <div className='nav-mobile flex gap-10'>
                    <NavLink onClick={showNavbar} exact to='/' className='w-[5rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-[#ff3b65] duration-200'>
                        Home
                    </NavLink>
                    <NavLink onClick={showNavbar} exact to='/gallery' className='w-[5rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-[#ff3b65] duration-200'>
                        Gallery
                    </NavLink>
                    <NavLink onClick={showNavbar} to='/about' className='w-[5rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-red hover:text-[#ff3b65] duration-200'>
                        About
                    </NavLink>
