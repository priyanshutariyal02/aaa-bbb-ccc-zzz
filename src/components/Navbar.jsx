        ...
        >
            ...
            <nav ref={navRef} className="flex text-lg gap-[10rem] font-medium md-device">
                <div className='nav-mobile flex gap-10'>
                    <NavLink onClick={showNavbar} exact to='/' className='w-[6rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-[#ff3b65] duration-200'>
                        Home
                    </NavLink>
                    <NavLink onClick={showNavbar} exact to='/gallery' className='w-[6rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-[#ff3b65] duration-200'>
                        Gallery
                    </NavLink>
                    <NavLink onClick={showNavbar} to='/about' className='w-[6rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-red hover:text-[#ff3b65] duration-200'>
                        About
                    </NavLink>
                    <NavLink onClick={showNavbar} to='/contact' className='w-[6rem] h-10 rounded-lg bg-white items-center justify-center flex font-bold shadow-md hover:text-red hover:text-[#ff3b65] duration-200'>
                        Contact
                    </NavLink>
            ...
            <button onClick={showNavbar} className='nav-btn bg-white rounded-xl p-3 shadow-md  text-[1.5rem]'>
                <FaBars />
            </button>
        </header>
    );
